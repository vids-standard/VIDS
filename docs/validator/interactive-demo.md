...
!!! info "About the profiles"
    **POC** enforces 15 rules (Structure, Imaging, Annotation, Metadata) for quick prototypes and pilots.
    **Full** enforces all 21 rules, adding Quality and ML Readiness for production and regulatory use.
